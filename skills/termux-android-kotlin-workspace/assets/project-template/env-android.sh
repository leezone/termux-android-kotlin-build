...
export ANDROID_COMPILE_API=__COMPILE_SDK__
export ANDROID_TARGET_API=__TARGET_SDK__
export ANDROID_MIN_API=__MIN_SDK__
export ANDROID_API=${ANDROID_API:-$ANDROID_COMPILE_API}
...
echo "ANDROID_COMPILE_API=$ANDROID_COMPILE_API"
